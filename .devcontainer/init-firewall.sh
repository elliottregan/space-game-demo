...
# Firewall initialization script for devcontainer
...
if [ -n "$DOCKER_DNS_RULES" ]; then
  ...
  # Use while loop instead of xargs -L for BusyBox compatibility (Alpine)
...
# Note: Using simple addition without aggregate tool (may not be available)
