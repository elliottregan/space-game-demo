...
// Note: Duplicated here since Vue SFC type exports don't work with bare re-exports
...
export type MetricVariant = "positive" | "negative" | "neutral" | "danger";
export type MiniStatMode = "default" | "compact";
