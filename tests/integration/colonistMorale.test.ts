...
describe("Colonist Morale Integration", () => {
  it("morale propagates through social network over time", () => {
    ...
    game.resources.add({ food: 500, water: 500, oxygen: 500, power: 500 });
    game.resources.addProduction({ food: 20, water: 20, oxygen: 20, power: 20 });
  ...
  it("game tick updates morale through tick phases", () => {
    ...
    game.resources.add({ food: 1000, water: 1000, oxygen: 1000, power: 1000 });
    game.resources.addProduction({ food: 50, water: 50, oxygen: 50, power: 50 });
